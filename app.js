...
// Example: 'https://script.google.com/macros/s/AKfycbxyz.../exec'
// ============================================
 ...
 * 3. Paste the complete Apps Script code (see GitHub repo README)
 * 4. Deploy as Web App
 * 5. Copy the URL and paste above
 * 
 * The script handles: test, getDashboard, getCustomers, addCustomer,
 * deleteCustomer, getTrips, addTrip, updateTrip, deleteTrip
 */
  ...
  appState.scheduledTrips.forEach((trip, index) => {
    ...
    tripCard.innerHTML = `
      ...
      <div class="trip-actions">
        <button class="btn btn--primary btn--sm" onclick="startScheduledTrip('${trip.id}')">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <polygon points="5 3 19 12 5 21 5 3"></polygon>
          </svg>
          Start
        </button>
        <button class="btn btn--secondary btn--sm" onclick="sendWhatsApp('${trip.phone}', 'trip_started', '${escapeHtml(trip.customer)}', '${trip.id}')">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>
          </svg>
          Message
        </button>
        <button class="btn btn--outline btn--sm btn-delete" onclick="deleteTrip('${trip.id}')">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  appState.customers.forEach(customer => {
    ...
    card.innerHTML = `
      ...
      <div class="customer-card-actions">
        <button class="btn btn--secondary btn--sm" onclick="callCustomer('${customer.phone}')">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
          </svg>
          Call
        </button>
        <button class="btn btn--secondary btn--sm" onclick="sendWhatsApp('${customer.phone}', 'trip_started', '${escapeHtml(customer.name)}', 'NEW')">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>
          </svg>
          Message
        </button>
        <button class="btn btn--outline btn--sm btn-delete" onclick="deleteCustomer('${customer.id}', '${escapeHtml(customer.name)}')">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <polyline points="3 6 5 6 21 6"></polyline>
            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
          </svg>
